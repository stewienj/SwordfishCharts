...
namespace Swordfish.NET.Charts {
  class D2DD3DImage : D3DImage, IDisposable {
    ...
    public IntPtr HWNDOwner {
      get {
        return (IntPtr)GetValue(HWNDOwnerProperty);
      }
      set {
        SetValue(HWNDOwnerProperty, value);
      }
    }
    ...
    public Action<IntPtr,bool> OnRender {
      get {
        return (Action<IntPtr,bool>)GetValue(OnRenderProperty);
      }
      set {
    ...
    public static readonly DependencyProperty OnRenderProperty =
        DependencyProperty.Register("OnRender", typeof(Action<IntPtr,bool>), typeof(D2DD3DImage), new UIPropertyMetadata(null, new PropertyChangedCallback(RenderChanged)));
