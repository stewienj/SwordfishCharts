...
namespace Swordfish.NET.Charts {
  ...
  public partial class TestPage : Window {
    ...
    public TestPage() {
      InitializeComponent();
      ChartUtilities.AddTestLines(_xyLineChart);
      _xyLineChart.SubNotes = new string[] { "Right or Middle Mouse Button To Zoom, Left Mouse Button To Pan, Right Double-Click To Reset" };
