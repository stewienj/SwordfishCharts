...
namespace Swordfish.NET.General {
  ...
  public class PeHeaderReader {
    ...
    public struct IMAGE_COR20_HEADER {
      ...
      // Just use this instead of the union above
      UInt32 EntryPoint;
    ...
    private const int IMAGE_DIRECTORY_ENTRY_COMHEADER = 14;
    ...
    public PeHeaderReader(string filePath) {
      ...
      using (FileStream stream = new FileStream(filePath, System.IO.FileMode.Open, System.IO.FileAccess.Read)) {
        ...
        long beginHeaderPos = stream.Position;
    ...
    /// <summary>
    /// Parameterless contructor required for serialization to xml
    /// </summary>
    ...
    public IMAGE_DATA_DIRECTORY ClrRuntimeHeader
    {
      get
      {
        ...
        if (Is32BitHeader)
        {
          directory = optionalHeader32.CLRRuntimeHeader;
        }
        else
        {
          directory = optionalHeader64.CLRRuntimeHeader;
        }
        return directory;
      }
    }

    public bool IsComOrClr
    {
      get
      {
        IMAGE_DATA_DIRECTORY directory = ClrRuntimeHeader;

        var expectedSize = Marshal.SizeOf(typeof(IMAGE_COR20_HEADER));

        // Some F# assemblies have a size of 8, this gives just enough info for the .NET runtime to start loading
        // the section as the first 4 bytes of the entry contain the length of the entry.
        if (directory.VirtualAddress == 0 || directory.Size == 0 || (directory.Size < expectedSize && directory.Size!=8)) 
        {
          return false;
        }
        else
        {
          // TODO: read in header
          // See GetAssemblyStrongNameLevel() in https://github.com/Microsoft/msbuild/blob/master/src/Tasks/StrongNameUtils.cs
          // And https://github.com/Microsoft/msbuild/blob/master/src/Tasks/NativeMethods.cs
          return true;
        }
      }
    }
